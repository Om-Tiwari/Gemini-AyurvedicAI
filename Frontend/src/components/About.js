        ...
        <>
          <header>
            ...
            <div className="title1">
              ...
              <button className="start1" onClick={() => setOpen(true)}>
                {" "}
                Get Started{" "}
              </button>
              <Form
          ...
          <section className="ayurveda1">
            <div className="ayu1">
              <p>
                <em>
                  At Ayurmedic, we believe in the age-old wisdom of Ayurveda,
                  which harnesses the natural healing properties of herbs to
                  promote holistic well-being. Explore our curated selection of
                  Ayurvedic herbs, each carefully chosen for its unique
                  therapeutic benefits. From Ashwagandha for stress relief to
                  Turmeric for its anti-inflammatory properties, our herbs are
                  sourced for purity and potency. Unlock the secrets of Ayurveda
                  and embark on a journey towards a healthier, balanced life.
                </em>
              </p>
            </div>
          </section>
          ...
          <section className="ayurvedic-herbs1">
            ...
            <div className="ayurvedic-herbs-info1">
              ...
              <p>
                Explore a wide range of Ayurvedic herbs and supplements for
                holistic wellness.
              </p>
              <a href="ayurvedic_medicines.html" className="cta-button">
                Browse Herbs
              </a>
            </div>
          </section>
          ...
          <section className="diet-chart1">
            <div className="diet-chart-info1">
              ...
              <p>
                Discover personalized Ayurvedic diet plans tailored to your
                dosha and health goals.
              </p>
              <a href="diet_plans.html" className="cta-button">
                Explore Diet Plans
              </a>
            </div>
          ...
          <section className="yoga-exercise1">
            ...
            <div className="yoga-exercise-info1">
              ...
              <p>
                Explore a collection of yoga exercises to enhance your physical
                and mental health.
              </p>
              <a href="yoga_exercises.html" className="cta-button">
